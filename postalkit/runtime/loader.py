...
def load_libpostal() -> ctypes.CDLL:
    ...
    if not lib_path.exists():
        ...
        try:
            ...
            pass
        raise DependencyMissingError(
            f"Could not find {lib_name} in {bin_dir}, bundled {bundled_lib_path}, "
            "or system paths. Run initialization first."
        )
    ...
    try:
        ...
        raise DependencyMissingError(f"Failed to load shared library {lib_path}: {e}") from None
